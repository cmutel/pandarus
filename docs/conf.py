...
project = "Pandarus"
copyright = "2013, Chris Mutel, ETH Zürich, and PSI"
...
latex_documents = [
    ("index", "Pandarus.tex", "Pandarus Documentation", "Chris Mutel", "manual"),
]
...
man_pages = [("index", "Pandarus", "Pandarus Documentation", ["Chris Mutel"], 1)]
