...
project = u'mapmatcher'
copyright = u'2013, Chris Mutel and ETH Zürich'
...
latex_documents = [
  ('index', 'Pandarus.tex', u'Pandarus Documentation',
...
man_pages = [
    ('index', 'Pandarus', u'Pandarus Documentation',
     [u'Chris Mutel'], 1)
]
...
texinfo_documents = [
  ('index', 'Pandarus', u'Pandarus Documentation',
   u'Chris Mutel', 'Pandarus', 'One line description of project.',
   'Miscellaneous'),
]
